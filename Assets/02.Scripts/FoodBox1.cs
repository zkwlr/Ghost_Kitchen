...
public class IngredientBox : MonoBehaviour
{
    ...
    [Header("손 설정")]
    public XRBaseInteractor leftHand;  // Inspector에서 Left Direct Interactor 할당
    public XRBaseInteractor rightHand; // Inspector에서 Right Direct Interactor 할당
